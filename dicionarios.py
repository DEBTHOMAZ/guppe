...
pais = paises.get('py', 'Não encontrado')  # não sabia que get fazia isso!
...
# Podemos utilizar qualquer tipo de dado (int, float, sring, boolean), inclusive lista, tupla, dicionário, como chaves
# de dicionários.
